...
"""
    ...
    Copied from 
    @http https://github.com/graphdeeplearning/graphtransformer/blob/main/layers/graph_transformer_edge_layer.py
...
class GraphTransformerLayer(nn.Module):
    ...
    def forward(self, g, h, e):
        ...
        :param g: ??
        :param h: hidden states -- sentence representations from the previous module
        :param e: edge weights or features
        :return: encoded h and e representations
