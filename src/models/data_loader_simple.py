    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            if (is_test):
                ...
                intro_summary_str = [x for x in data['intro_summary_text']]
                setattr(self, 'intro_summary_str', intro_summary_str)
            ...
            for idx, minibatch in enumerate(self.batches):
                ...
                if not self.is_test:
                    ...
                    minibatch = {
                        ...
                        'segment_ids': [m[4] for m in minibatch],
                        'cls_ids': [m[5] for m in minibatch],
                        'src_txt': [m[6] for m in minibatch],
                        'tgt_txt': [m[7] for m in minibatch],
                    }
